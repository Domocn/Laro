        ...
        {showHelp && (
          ...
          >
            <h4 className="font-medium text-white mb-2 flex items-center gap-2">
              <Mic className="w-4 h-4 text-laro" />
              Voice Commands
            </h4>
            <ul className="text-sm text-gray-300 space-y-1">
              <li><span className="text-laro">"Next"</span> - Go to next step</li>
              <li><span className="text-laro">"Previous"</span> - Go back</li>
              <li><span className="text-laro">"Repeat"</span> - Read again</li>
              <li><span className="text-laro">"Ingredients"</span> - List ingredients</li>
              <li><span className="text-laro">"Start timer"</span> - Start timer</li>
              <li><span className="text-laro">"Stop timer"</span> - Stop timer</li>
            </ul>
