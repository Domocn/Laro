      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-laro flex items-center justify-center">
...
export const AIAssistantButton = ({ onClick }) => {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      onClick={onClick}
      className="fixed bottom-24 right-4 w-14 h-14 rounded-full bg-laro text-white shadow-lg flex items-center justify-center z-40 hover:bg-laro-dark transition-colors"
