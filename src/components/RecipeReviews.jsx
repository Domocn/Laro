    ...
    >
      ...
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-laro-light flex items-center justify-center">
            <User className="w-4 h-4 text-laro" />
          </div>
          <div>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-border/60">
        <button
          ...
          className="flex items-center gap-1 text-xs text-muted-foreground hover:text-laro transition-colors"
        >
        ...
        {isOwner && (
          <div className="flex gap-2">
            <button
              ...
              className="text-xs text-muted-foreground hover:text-laro"
            >
...
export const RecipeReviews = ({ recipeId, currentUserId }) => {
  ...
  const handleHelpful = async (reviewId) => {
    try {
      ...
      toast.error('Could not mark as helpful (E-RR002)');
    }
  };
  ...
  const handleDelete = async (reviewId) => {
    ...
    try {
      ...
      toast.error('Could not delete review (E-RR003)');
    }
  };
                  ...
                  {ratingSummary && (
                    <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-xl">
                      <div className="text-center">
                        <p className="text-4xl font-bold text-laro">{ratingSummary.average}</p>
                        <StarRating rating={Math.round(ratingSummary.average)} readonly size="sm" />
