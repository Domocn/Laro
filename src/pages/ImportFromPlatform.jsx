...
const platforms = [
  ...
  },
  {
    ...
    instructions: 'Use Laro format or any structured recipe JSON'
  }
];
...
export const ImportFromPlatform = () => {
  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      ...
      toast.error('Couldn\'t read that file. Please try again. (E-IP001)');
    }
  };
  ...
  const handleImport = async () => {
    ...
    try {
      const response = await api.post('/import/platform', {
    ...
    <div className="min-h-screen bg-cream-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-laro-800 flex items-center gap-3">
            <Download className="w-8 h-8" />
            Import Recipes
          </h1>
          <p className="text-laro-600 mt-2">
            ...
            <Card
              ...
              className={`cursor-pointer transition-all hover:shadow-md ${
                selectedPlatform === platform.id 
                  ? 'ring-2 ring-laro-500 bg-laro-50' 
                  : 'hover:bg-cream-100'
              }`}
          ...
          >
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {/* Sample Format */}
                <details className="bg-laro-50 rounded-lg p-4">
                  <summary className="cursor-pointer text-sm font-medium text-laro-700">
                ...
                <Button
                  ...
                  className="w-full bg-laro-600 hover:bg-laro-700"
                  ...
                  <CardContent className="pt-6">
                    {result.success ? (
                      <div className="text-center">
                        ...
                        <Button
                          onClick={() => navigate('/recipes')}
                          className="mt-6 bg-laro-600 hover:bg-laro-700"
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-laro-600 mt-2">{result.error}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
