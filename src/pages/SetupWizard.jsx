...
export const SetupWizard = () => {
  ...
  const handleNext = async () => {
    if (currentStep === STEPS.length - 2) {
      ...
      try {
        ...
        toast.error(error.response?.data?.detail || 'Couldn\'t save your settings. Please try again. (E-SW001)');
      } finally {
        setSaving(false);
      }
  ...
  const testEmailConfig = async () => {
    ...
    try {
      ...
      toast.error('Email test failed (E-SW002)');
    } finally {
            ...
            return (
              <div key={step.id} className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                  isActive ? 'bg-laro text-white' :
                  isComplete ? 'bg-green-500 text-white' :
                  'bg-white dark:bg-card border-2 border-border/60 text-muted-foreground'
                }`}>
                  {isComplete ? <Check className="w-5 h-5" /> : <Icon className="w-5 h-5" />}
                </div>
                <span className={`text-xs mt-1 hidden sm:block ${isActive ? 'text-laro font-medium' : 'text-muted-foreground'}`}>
                  {step.title}
                </span>
              </div>
            );
        ...
        <div className="bg-white dark:bg-card rounded-2xl border border-border/60 overflow-hidden shadow-lg">
          <AnimatePresence mode="wait">
            ...
            {currentStep === 0 && (
              ...
              >
                <div className="w-20 h-20 bg-laro/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
                ...
                <div className="bg-cream-subtle dark:bg-muted p-4 rounded-xl text-left space-y-3">
                  <p className="text-sm flex items-center gap-3">
                    <Shield className="w-5 h-5 text-laro flex-shrink-0" />
                    <span>Configure security & password policies</span>
                  </p>
                  <p className="text-sm flex items-center gap-3">
                    <Users className="w-5 h-5 text-laro flex-shrink-0" />
                    <span>Set up user registration rules</span>
                  </p>
                  <p className="text-sm flex items-center gap-3">
                    <Mail className="w-5 h-5 text-laro flex-shrink-0" />
                    <span>Configure email notifications</span>
                  </p>
                  <p className="text-sm flex items-center gap-3">
                    <Globe className="w-5 h-5 text-laro flex-shrink-0" />
            ...
            {currentStep === 2 && (
              ...
              >
                <h2 className="font-heading text-xl font-bold mb-2 flex items-center gap-2">
                  <Users className="w-6 h-6 text-laro" />
            ...
            {currentStep === 3 && (
              ...
              >
                <h2 className="font-heading text-xl font-bold mb-2 flex items-center gap-2">
                  <Mail className="w-6 h-6 text-laro" />
                  Email Configuration
                </h2>
                <p className="text-muted-foreground mb-6 text-sm">
                      ...
                      {settings.email_provider === 'smtp' ? (
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            ...
                            <a href="https://resend.com" target="_blank" rel="noopener noreferrer" className="text-laro hover:underline">
            ...
            {currentStep === 4 && (
              ...
              >
                <h2 className="font-heading text-xl font-bold mb-2 flex items-center gap-2">
                  <Globe className="w-6 h-6 text-laro" />
                  Social Login (OAuth)
                </h2>
                <p className="text-muted-foreground mb-6 text-sm">
                  ...
                  <div className="border border-border/60 rounded-xl overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        <a href="https://console.cloud.google.com/apis/credentials" target="_blank" rel="noopener noreferrer" className="text-laro hover:underline">
                  ...
                  <div className="border border-border/60 rounded-xl overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        <a href="https://github.com/settings/developers" target="_blank" rel="noopener noreferrer" className="text-laro hover:underline">
