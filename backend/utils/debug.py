...
def setup_debug_logging():
    ...
    # Configure laro.* loggers
    for logger_name in ['laro', 'laro.debug', 'laro.auth', 'laro.db', 'laro.api',
                        'laro.websocket', 'laro.ai', 'laro.recipes', 'laro.meal_plans',
                        'laro.shopping', 'laro.admin', 'laro.security', 'laro.cache',
                        'laro.celery', 'laro.context']:
    ...
    debug_logger = logging.getLogger("laro.debug")
...
class DebugLogger:
    ...
    def __init__(self, module: str):
        self.module = module
        self.logger = logging.getLogger(f"laro.{module}")
...
def enable_verbose_debug():
    ...
    logging.getLogger("laro").setLevel(logging.DEBUG)
    debug_logger.info("Verbose debug logging enabled")


def disable_verbose_debug():
    """Disable verbose debug logging."""
    logging.getLogger("laro").setLevel(logging.INFO)
